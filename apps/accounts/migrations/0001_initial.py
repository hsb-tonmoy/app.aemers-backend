    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_opening', models.PositiveSmallIntegerField(choices=[(0, 'Pending'), (1, 'Started'), (2, 'Complete')], default=1, verbose_name='File Opening')),
                ('pre_application_form', models.PositiveSmallIntegerField(choices=[(0, 'Pending'), (1, 'Started'), (2, 'Complete')], default=1, verbose_name='Pre-Application Form')),
                ('documents_upload', models.PositiveSmallIntegerField(choices=[(0, 'Pending'), (1, 'Started'), (2, 'Complete')], default=1, verbose_name='Documents Upload')),
                ('application_submission', models.PositiveSmallIntegerField(choices=[(0, 'Pending'), (1, 'Started'), (2, 'Complete')], default=0, verbose_name='Application Submission')),
