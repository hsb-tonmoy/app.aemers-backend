    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('english_proficiency_score', models.CharField(blank=True, max_length=255, null=True, verbose_name='English Proficiency Score')),
                ('english_proficiency_date_of_examination', models.DateField(blank=True, null=True, verbose_name='English Proficiency Test Date')),
                ('english_proficiency_trf_no', models.CharField(blank=True, max_length=255, null=True, verbose_name='English Proficiency TRF No.')),
                ('english_proficiency_waivers', models.BooleanField(default=False, verbose_name='English Proficiency Waiver?')),
                ('english_proficiency_listening', models.CharField(blank=True, max_length=5, null=True, verbose_name='English Proficiency Listening')),
                ('english_proficiency_speaking', models.CharField(blank=True, max_length=5, null=True, verbose_name='English Proficiency Speaking')),
                ('english_proficiency_reading', models.CharField(blank=True, max_length=5, null=True, verbose_name='English Proficiency Reading')),
                ('english_proficiency_writing', models.CharField(blank=True, max_length=5, null=True, verbose_name='English Proficiency Writing')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pre_app_form', to=settings.AUTH_USER_MODEL)),
            ],
            options={
